...
<figure>
  ...
  <img style="max-width: 60%;" src="loom_signup.png" alt="Loom Sign Up"/>
</figure>
...
<figure>
  ...
  <img style="max-width: 60%;" src="loom_download.png" alt="Loom Download"/>
</figure>

It is preferred to download the `Desktop App` so you can show your `IDE` when explaining your code, but the `Desktop App` is not currently available for `Linux`. <br>
